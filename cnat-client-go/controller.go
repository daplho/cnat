...
import (
	...
	cnatv1alpha1 "github.com/daplho/cnat/cnat-client-go/pkg/apis/cnat/v1alpha1"
	clientset "github.com/daplho/cnat/cnat-client-go/pkg/generated/clientset/versioned"
	cnatscheme "github.com/daplho/cnat/cnat-client-go/pkg/generated/clientset/versioned/scheme"
	informers "github.com/daplho/cnat/cnat-client-go/pkg/generated/informers/externalversions/cnat/v1alpha1"
	listers "github.com/daplho/cnat/cnat-client-go/pkg/generated/listers/cnat/v1alpha1"
)
...
func (c *Controller) processNextWorkItem() bool {
	...
	err := func(obj interface{}) error {
		...
		if when, err := c.syncHandler(key); err != nil {
			...
			// get queued again until another exchange happens.
			c.workqueue.Forget(obj)
		}
		// Finally, if no error occurs we Forget this item so it does not
...
func (c *Controller) syncHandler(key string) error {
	...
	case cnatv1alpha1.PhasePending:
		...
		// to check if it's already time to act:
		...
		klog.Infof("instance %s: it's time! Ready to execute: %s", key,
